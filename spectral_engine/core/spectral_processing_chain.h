...
#define SPECTRAL_PROC_DETERMINISTIC_MODEL    SPECTRAL_PROC_SERRA_SMITH_1990
#define SPECTRAL_PROC_PSYCHOACOUSTIC_MASK    SPECTRAL_PROC_JOHNSTON_1988
#define SPECTRAL_PROC_ADAPTIVE_DENSITY       SPECTRAL_PROC_ADAPTIVE_TRACK_DENSITY
#define SPECTRAL_PROC_MCAULAY_QUATIERI_1986  SPECTRAL_PROC_ADAPTIVE_TRACK_DENSITY

#define SPECTRAL_PROC_DEFAULT SPECTRAL_PROC_NONE
