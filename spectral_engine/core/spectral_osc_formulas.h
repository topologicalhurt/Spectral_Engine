...
#define METAL_CONST_TWO_PI       SPECTRAL_STR(SPECTRAL_TWO_PI) "f"
#define METAL_CONST_INV_TWO_PI   SPECTRAL_STR(SPECTRAL_INV_TWO_PI) "f"
#define METAL_CONST_INV_PI       SPECTRAL_STR(SPECTRAL_INV_PI) "f"
#define METAL_CONST_INV_PI_SQ    SPECTRAL_STR(SPECTRAL_INV_PI_SQ) "f"
#define METAL_CONST_PI           SPECTRAL_STR(SPECTRAL_PI) "f"
