...
if(APPLE)
    target_link_options(q15_production_parity_test PRIVATE -Wl,-dead_strip)
else()
    target_compile_options(q15_production_parity_test PRIVATE -ffunction-sections -fdata-sections)
    target_link_options(q15_production_parity_test PRIVATE -Wl,--gc-sections)
endif()
