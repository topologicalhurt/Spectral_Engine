...
#         core/oscillator.c (scalar), core/port/host/oscillator_simd.c (SIMDe pack8),
#         core/port/embedded/oscillator_simd.c (CMSIS).
#
...
foreach(_file IN LISTS _sources)
    ...
    if(_pin STREQUAL "")
        list(APPEND _violations
            "  ${_file}: includes the canonical Q15 contract (${_q15_header}) but carries no _Static_assert(... SPECTRAL_OSC_Q15_VERSION == ...) pin -- a Q15 re-implementer must version-handshake the contract so a bump forces re-validation here. See SPECTRAL_OSC_Q15_VERSION in ${_q15_header} and the existing pins in oscillator.c / port/host/oscillator_simd.c / port/embedded/oscillator_simd.c.")
    endif()
endforeach()
